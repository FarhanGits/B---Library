...
<body>
    <nav>
        ...
        <div class="secNav">
            <ul>
                ...
                <li><a href="/login-user" class="regularFont">Riwayat Kunjungan</a></li>
    ...
    <div class="container">
        ...
        <section class="sponsor-box">
            <div class="welcome">
                <img src="img/Noah Schumacher 1.svg" alt="">
            </div>
        </section>

        <!--BOOK RECOM SECTION-->
        <section class="book-recom">
            <h1 class="mediumFont">Rekomendasi buku</h1>
            <div class="slider-container-book">

                @foreach ($data->take(10) as $item)
                    <a href="/daftarkoleksi/buku/{{$item->id}}" class="card useBorder">
        ...
        <section class="news-trend">
            ...
            <div class="slider-container-news">
                ...
                <div class="news-box useBorder">
                    <a href="https://www.detik.com/edu/edutainment/d-6726759/pakar-ugm-ungkap-buku-bukan-alat-utama-belajar-lalu-apa">
                ...
                <!--Berita 2-->
                <div class="news-box useBorder">
                    <a href="https://www.liputan6.com/bisnis/read/5293197/sejarah-toko-buku-gunung-agung-yang-bermula-dari-kios-sederhana">
                        <div class="news-cover">
                            <img src="img/3-1.png" alt="">
                        </div>
                        <div class="news-details">
                ...
                <!--Berita 3-->
                <div class="news-box useBorder">
                    <a href="https://buku.kompas.com/read/4007/membangun-kekayaan-abadi-salah-satu-kebiasaan-berpikir-investor-terbaik-dunia-yang-harus-anda-tiru">
                        <div class="news-cover">
                            <img src="img/3-1.png" alt="">
                        </div>
                        <div class="news-details">
                ...
                <!--Berita 4-->
                <div class="news-box useBorder">
                    <a href="https://www.cnnindonesia.com/ekonomi/20230504172745-92-945358/tutup-toko-books-beyond-diskon-buku-sampai-80-persen">
                        <div class="news-cover">
                            <img src="img/3-1.png" alt="">
                        </div>
                        <div class="news-details">
                ...
                <!--Berita 5-->
                <div class="news-box useBorder">
                    <a href="https://nasional.sindonews.com/read/1105899/14/ksad-dudung-luncurkan-buku-muhammadiyah-doakan-segera-jadi-guru-besar-1684811102">
                        <div class="news-cover">
                            <img src="img/3-1.png" alt="">
                        </div>
                        <div class="news-details">
        ...
        <section class="pusling-schedule" id="pusling-schedule">
            ...
            <div class="slider-container-pusling">
                ...
                <div class="schedule-box useBorder">
                    <a href="#">
                        <div class="bus-img">
                            <img src="img/bus pusling.png" alt="">
                        </div>
