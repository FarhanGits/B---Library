...
<body>
    <div class="Koleksi">
        ...
        <div class="column left" style="background-color:white;">
            <img src="img/book/Futsal Modern.png">
        </div>
        <div class="column middle" style="background-color:white;">
            <h1>Taktik dan Strategi Futsal Modern</h1>
            <h2>Deskripsi Buku</h2>
            <p>Bermain Futsal tidak jauh berbeda dengan bermain sepak bola pada umumnya, butuh kekuatan stamina, mental dan strategi. Namun, ada sedikit perbedaan mendasar dalam hal pola permainan dan pengaturan serangan. Pola permainan dalam Futsal banyak didominasi permainan kaki ke kaki, pada saat menyerang lebih banyak dilakukan dengan umpan-umpan pendek, mengingat ukuran lapangan yang lebih kecil dibanding lapangan sepak bola. Dengan pola seperti ini skill dan kekompakan tim terutama dalam mengolah bola, mengumpan, menjaga pertahanan dan menyerang ke daerah lawan sangat diperlukan. Dalam buku ini akan dijelaskan beragam strategi bermain futsal, baik itu dalam bertahan maupun menyerang. Tidak hanya formasi saat bermain bertahan ataupun menyerang, tetapi juga strategi bagaimana membuat peluang dari sepak pojok hingga tendangan bebas. Buku ini pun dilengkapi foto dan gambargambar dari setiap materi sehingga pembaca dari tingkat pemula hingga tingkat mahir dapat dengan mudah mempraktikkannya.</p>
        </div>
