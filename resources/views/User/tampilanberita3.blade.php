...
<div class="row">
  ...
  <div class="column middle" style="background-color:white;">
    <h1>Komisi x DPR Minta Literasi Nasional Ditingkatkan</h1>
    <!-- <h2>Deskripsi Buku</h2> -->
    <p>Masyarakat berpengetahuan atau masyarakat literat menjadi fondasi sosial untuk mendorong proses transformasi masyarakat menuju kehidupan yang sejahtera. Untuk itu, pembangunan kemampuan literasi masyarakat merupakan keharusan, sehingga sumber daya manusia (SDM) yang berkualitas dan memiliki daya saing dapat terwujud. Hal ini disampaikan Wakil Ketua Komisi X DPR RI, Agustina Wilujeng, dalam Rapat Dengar Pendapat (RDP) antara Komisi X DPR RI dan Perpustakaan Nasional RI (Perpusnas), Kementerian PPN/Badan Perencanaan Pembangunan Nasional (Bappenas), serta Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi (Kemendikbud Ristek), di Ruang Rapat Komisi X DPR, Jakarta, pada Selasa (14/2/2022). Secara umum, Perpusnas, Kementerian PPN/Bappenas, dan Kemendikbud Ristek sepakat bahwa penciptaan SDM berkualitas dan berdaya saing harus dilaksanakan secara holistik dan integratif dengan melibatkan segenap komponen bangsa. RDP lintas kementerian/lembaga tersebut mengagendakan peningkatan literasi nasional terkait indeks literasi berdasarkan Perpusnas dan UNESCO.
        </p>
  </div>
