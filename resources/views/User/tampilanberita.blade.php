...
<div class="row">
  <div class="column left" style="background-color:white;">
    <img src="img/berita1.png">
  </div>
  <div class="column middle" style="background-color:white;">
    <h1>Penyebaran Hoaks dan Rendahnya Kemampuan Identifikasi Informasi</h1>
    <!-- <h2>Deskripsi Buku</h2> -->
    <p>Penyebaran hoaks saat ini begitu banyak beredar, terutama di media sosial dan aplikasi pesan. Akan tetapi, masih banyak masyarakat Indonesia yang tidak mengecek informasi yang diterima. Berdasarkan survei yang dilakukan Kementerian Komunikasi dan Informatika bersama Katadata Insight Center, sebagian masyarakat tidak mengecek kebenaran informasi di internet.
        Meski tidak mengecek kebenaran informasi itu, mereka tetap menyebarkannya. Survei memperlihatkan bahwa ada 52,2 persen responden yang tidak mengecek informasi berupa teks, gambar, video, hingga tautan yang ada di medsos. Sisanya, 47,8 persen, melakukan penelusuran jika ada konten atau unggahan di media sosial yang dinilai mencurigakan. Apa saja penelusuran yang dilakukan? Bagaimana kemampuan mengidentifikasi hoaks masyarakat Indonesia? Simak dalam infografik berikut ini:
        </p>
  </div>
